...
(() => {
    ...
    let first_input_weightage = parseInt(first_weightage.options[first_weightage.options.selectedIndex].textContent);
    let second_input_weightage = parseInt(second_weightage.options[second_weightage.options.selectedIndex].textContent);
    let third_input_weightage = parseInt(third_weightage.options[third_weightage.options.selectedIndex].textContent);
